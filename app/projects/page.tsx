...
export default async function Projects() {
  ...
  const { data:projects, error } = await supabase.from('review_projects').select('*,products!review_projects_product_owner_fkey(title)').eq('user_id',user.id).order('created_at',{ascending:false});
