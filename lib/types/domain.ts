...
export type Product = { id:string; user_id:string; title:string; category:string; affiliate_link:string; product_url?:string|null; source?:'manual'|'mock'|'shopee_api'; affiliate_validation_status?:'pending'|'validated'|'rejected'; image_url?:string|null; price?:number|null; commission_rate?:number|null; risk_flags:string[]; created_at:string; updated_at:string };
export type ReviewProject = { id:string; user_id:string; product_id:string; title:string; status:ProjectStatus; compliance_status?:ComplianceStatus|null; approval_status?:ApprovalStatus|null; has_affiliate_disclosure:boolean; has_ai_content_label:boolean; media_revision:number; archived_at?:string|null; created_at:string; updated_at:string };
